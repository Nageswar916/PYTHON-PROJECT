...
void setup() {
 pinMode(8, OUTPUT); // Enable pin for all axes
   digitalWrite(8, LOW);
  // Set initial seed values for the steppers
  LeftFrontWheel.setMaxSpeed( 12800);
  LeftBackWheel.setMaxSpeed(12800);
  RightFrontWheel.setMaxSpeed(12800);
  RightBackWheel.setMaxSpeed(12800);
